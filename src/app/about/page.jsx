...
const About = () => {
  ...
  const skillReff = useRef();
  //const isSkillReffInView = useInView(skillReff, {once:true});
  const isSkillReffInView = useInView(skillReff, { margin: "-100px" });

  const experienceReff = useRef();
  const isexperienceReffInView = useInView(experienceReff, { margin: "-100px" });
  ...
  return (
    <motion.div className="h-full"
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/* Text Container*/}
        <div className="p-4 sm:p-8 md:p-12 lg:p-28 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64  lg:w-2/3 lg:pr-0 xl:1/2">
          {/*Biography Container*/}
          ...
          {/*Skills Container*/}
          <div className="flex flex-col gap-12 justify-center" ref={skillReff}>
            {/*Skills Heading*/}
            <motion.h1
              initial={{ x: "-300px" }}
              animate={isSkillReffInView ? { x: 0 } : {}}
          ...
          <div className="flex flex-col gap-12 justify-center pb-48" ref={experienceReff}>
            {/*Experience Heading*/}
            <motion.h1
              initial={{ x: "-300px" }}
              animate={isexperienceReffInView ? { x: "0" } : {}}
              transition={{ delay: 0.2 }}
